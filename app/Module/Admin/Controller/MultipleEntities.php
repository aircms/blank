 ...
 * @mod-filter {"type": "model", "by": "singleModelRef", "field": "title", "model": "\\App\\Model\\MultipleEntities"}
 * @mod-filter {"type": "dateTime", "by": "createdAt"}
 */
class MultipleEntities extends Multiple
{
}
